<template>
    <view class="chatroomBox">
        <view class="chat-top" @touchstart="hideDrawer">
            <view class="h-bg">
                 <image v-if="false" src="../../../static/image/timg2.jpg" mode="scaleToFill"></image>
            </view>
    ...
    export default {
        ...
        data() {
            return {
                ...
                scrollToView: '',
                myuid: 0,
				userInfo:{avatar:'',name:'bin'},
				currentToUser:{avatar:'',name:'public'},
        ...
        methods: {
            init(){
                ...
                try{
					...
					tempArr = [{id:0,classify:'user',body:{type:'text',message:'xxddddddddddddddddddddddddddd',isme:true,attachments:[]}},
						{id:1,classify:'user',body:{type:'text',message:'xxsx',isme:false,attachments:[]}},
						{id:2,classify:'user',body:{type:'text',message:'xxsx',isme:false,attachments:[]}},
						{id:3,classify:'user',body:{type:'text',message:'xxsx',isme:true,attachments:[]}}
					]
                    if(tempArr.length>0){
						userInfo.avatar ='/static/logo.png'
						currentToUser.avatar ='/static/my-current.png'
                        tempArr.forEach(item=>{
                            item.id ='msg'+ '22202'// UUID(10)
